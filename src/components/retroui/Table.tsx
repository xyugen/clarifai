...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto">
    <table
      ref={ref}
      className={cn(
        "w-full caption-bottom border-2 text-sm shadow-lg",
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "bg-primary text-primary-foreground font-head [&_tr]:border-b",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "p-2 align-middle md:p-3 [&:has([role=checkbox])]:pr-0",
      className,
    )}
    {...props}
  />
